...
from soloFlix.views import videoViewSet
...
class MeuControllerTeste(TestCase):
    ...
    def test_cria_objeto(self):
        ...
        dados = {'titulo': 'Novo filme', 'categoria': 'Filme', 'descricao': 'Um filme criado para testes', 'url': 'https://www.exemplo.com'}
